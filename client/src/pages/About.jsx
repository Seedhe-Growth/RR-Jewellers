    ...
    <div className="bg-[#FFFDFB] dark:bg-[#0A0A0A] min-h-screen pt-24 transition-colors duration-300">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center flex flex-col items-center gap-6 px-6">
          <span className="text-primary tracking-[0.5em] uppercase text-xs font-semibold">EST. 2024</span>
          <h1 className="text-5xl md:text-7xl font-serif gold-text uppercase tracking-widest">Our Legacy</h1>
      ...
      <section className="section-padding grid grid-cols-1 lg:grid-cols-2 gap-20 items-center max-w-7xl mx-auto">
        ...
        >
          <div className="absolute top-0 left-0 w-full h-full border border-primary/20 translate-x-6 translate-y-6" />
          <img 
      ...
      <section className="bg-brand-beige/20 dark:bg-white/[0.02] py-24 px-6 md:px-12">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div key={idx} className="glass-card flex flex-col items-center text-center gap-6 group hover:-translate-y-4 transition-all duration-500">
